...
export default ({ width, height, fill }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25.5 39.96" width={width || 26} height={height || 40}>
        <title>elder care</title>
        <g id="Layer_2" data-name="Layer 2">
            <g id="OBJECTS">
                <path fill={fill || "#000000"} class="cls-1" d="M20.61,22a1.25,1.25,0,0,1-.94.41H14.73a1.38,1.38,0,0,1-.85-.29,2.77,2.77,0,0,0-1.47,2.1l-.35,2.84H22.62l-.36-2.87A2.74,2.74,0,0,0,20.61,22Z"/>
